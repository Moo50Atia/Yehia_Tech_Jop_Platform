    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6">
            <ul class="space-y-2">
                ...
                <!-- Companies -->
                <x-sidebar-nav-link :href="route('company.index')" :active="request()->routeIs('company.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Applications -->
                <x-sidebar-nav-link :href="route('application.index')" :active="request()->routeIs('application.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Categories -->
                <x-sidebar-nav-link :href="route('category.index')" :active="request()->routeIs('category.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Job Vacancies -->
                <x-sidebar-nav-link :href="route('job-vacancy.index')" :active="request()->routeIs('job-vacancy.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

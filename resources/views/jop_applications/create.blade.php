<div class="container">
    <h2>Create jop_applications</h2>
    <form action="{{ route('jop_applications.store') }}" method="POST">
        @csrf
        <div class="mb-3">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="job_vacansy_id" value="{{old("job_vacansy_id")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="resume_id" value="{{old("resume_id")}}">
            @error("resume_id")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="aiGeneratedScore" value="{{old("aiGeneratedScore")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="aiGeneratedFeedback" value="{{old("aiGeneratedFeedback")}}">

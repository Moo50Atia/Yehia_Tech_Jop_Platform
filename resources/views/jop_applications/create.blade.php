    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-xl">
                <form action="{{ route('admin.applications.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="job_vacansy_id" id="job_vacansy_id" required
                            ...
                            <option value="{{ $vacancy->id }}" {{ old('job_vacansy_id') == $vacancy->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="number" name="aiGeneratedScore" id="aiGeneratedScore" value="{{ old('aiGeneratedScore', 0) }}" min="0" max="100" step="0.1"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 shadow-sm">
                    ...
                    <div>
                        ...
                        <textarea name="aiGeneratedFeedback" id="aiGeneratedFeedback" rows="4"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 shadow-sm">{{ old('aiGeneratedFeedback') }}</textarea>

...
{{-- Original backend form action: route('resume.store') --}}
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="resume_content" id="resume_content" rows="12" required
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 shadow-sm font-mono text-sm"
                    ...
                    <div>
                        ...
                        <input type="text" name="skills" id="skills" placeholder="e.g., JavaScript, React, Node.js, Python"
                            class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 shadow-sm">
